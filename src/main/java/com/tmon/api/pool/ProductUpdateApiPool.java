...
public class ProductUpdateApiPool implements Runnable {
	 ...
	 * @param mhItem
	 */
	public ProductUpdateApiPool(ProdService prodService, ApiKafkaClient apiKafkaClient, Map<String, Object> mhItem) {
		super();
	...
	public void run() {
		try {
			Map<String, Object> resultMap = this.prodService.updateProducts(this.mhItem);
